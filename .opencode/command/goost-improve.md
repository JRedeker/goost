...
3. Examine each of the 5 core categories
4. Gather evidence for potential findings
5. Assign severity and sort
6. Generate hybrid search queries
7. Output the IMPROVEMENT OPPORTUNITIES report
