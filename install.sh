...
echo "  /openspec-proposal - Create new change proposal (design phase)"
echo "  /openspec-clarify  - Socratic questions for acceptance criteria"
echo "  /openspec-research - Research and validate architectural decisions"
...
echo "  /openspec-status   - Fast overview of project state"
...
echo "  /openspec-archive  - Archive completed change"
echo ""
